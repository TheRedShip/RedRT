...
/*   Updated: 2024/05/22 18:45:30 by ycontre          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_scene(Scene *scene)
{
	...
	Sphere sphere[objNum] = {{ {-75.0f, 25.0f, 0.0f, 60.0f}, {1.0f, 1.0f, 1.0f, 0.0f}, {0.0,0,0,0} },
							{ {75.0f, 25.0f, 0.0f, 60.0f}, {1.0f, 1.0f, 1.0f, 0.0f}, {0.0,1,0,0} },
							{ {0.0f, 0.75f, -3.0f, 1.0f}, {1.0f, 1.0f, 1.0f, 0.0f}, {1.0f,0,0,0} },
							{ {0.0f, 2.80f, -3.0f, 1.0f}, {1.0f, 1.0f, 1.0f, 0.0f}, {1.0f,0,0,0} },
							{ {-0.3f, 0.70f, -1.0f, 0.75f}, {0.2f, 1.0f, 0.2f, 0.0f}, {0,0,0,0} },
